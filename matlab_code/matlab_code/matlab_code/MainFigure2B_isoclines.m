% The script generates the isoclines shown in Fig. 2B for the two-state system - case 2 - 
% by setting K_y (=0.4 and 0.1 as shown in Fig. 2B of the ms).
...
for idx_n_y=1:length(n_y_v)
    ...
    % n_y value
    n_y=n_y_v(idx_n_y);
    m_y=(k*alpha*K_y-gamma*(m_x+beta/2))*(1/alpha);
    ...
    plot(y_ss,gamma*x_ss_nonlin,tag_line_col,'linewidth',line_w);
