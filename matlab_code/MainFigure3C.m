...
% The script generates the results shown in Figure 3C by setting Ky=0.4 or 0.1.
...
for idx_ny=1:length(v_ny)
    ...
    if idx_ny==1       
        ...
        eval (['load sys_case3','_Ky_',num2str(Ky*100),'_Kx_',num2str(Kx*100),'_nx_',num2str(nx),'_distur_',num2str(perc_dist*100),'_perc100_par']);
    end
    ...
    if idx_ny==1
        eval (['save sys_case3','_Ky_',num2str(Ky*100),'_Kx_',num2str(Kx*100),'_nx_',num2str(nx),'_distur_',num2str(perc_dist*100),'_perc100_par   PP']);
    end 
    eval (['save sys_case3','_Ky_',num2str(Ky*100),'_Kx_',num2str(Kx*100),'_ny_',num2str(ny),'_nx_',num2str(nx),'_distur_',num2str(perc_dist*100),'_perc100_par Z Z_scale ZZ ZZ_scale PP']);
